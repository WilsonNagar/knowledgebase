...
diagrams: []
examples: []
canonical_id: "android-intermediate-18"
---
    ...
    override fun onUpdate(context: Context, appWidgetManager: AppWidgetManager, appWidgetIds: IntArray) {
        for (appWidgetId in appWidgetIds) {
            ...
            lifecycleScope.launch {
                ...
                // Update views
                views.setTextViewText(R.id.temperature, "${weather.temperature}°")
...
- [Android Services - Complete Guide](./14.%20Android%20Services%20-%20Complete%20Guide.md) - Background services
- [Broadcast Receivers](./16.%20Broadcast%20Receivers.md) - Widget provider extends BroadcastReceiver

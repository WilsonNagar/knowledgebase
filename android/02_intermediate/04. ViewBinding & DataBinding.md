...
diagrams: []
examples: []
canonical_id: "android-intermediate-04"
---
...
3. **B** - `@{}` is one-way binding (data to view), `@={}` is two-way binding (data ↔ view)
...
- [Jetpack Compose UI Components & Theming](./02.%20Jetpack%20Compose%20UI%20Components%20%26%20Theming.md) - Modern UI approach
- [Unit Testing in Android](./28.%20Unit%20Testing%20in%20Android.md) - Testing with ViewBinding
